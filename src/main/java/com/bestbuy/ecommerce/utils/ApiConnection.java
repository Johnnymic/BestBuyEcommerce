...
public class ApiConnection {
    ...
    public ApiConnection(String url) throws NoSuchAlgorithmException, KeyManagementException {
        this.url = url;
        this.enforceTlSvPoint();
    }

    private void enforceTlSvPoint() throws NoSuchAlgorithmException, KeyManagementException {
